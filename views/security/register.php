    ...
    <div class="modal-body">
        <form method="post" action="<?= $this->base_url()?>security/new_user">
            <div class="row inscr">
                ...
                <div class="col-md-6">
                    <label>Nom* :</label>
                    <input name="nom" type="text" class="form-control input-lg" placeholder="Nom">
                </div>

                <div class="col-md-6">
                    <label>Prénom* :</label>
                    <input name="prenom" type="text" class="form-control input-lg" placeholder="Prénom">
                </div>

                <div class="col-md-6">
                    <label>Email* :</label>
                    <input name="email" type="email" class="form-control input-lg" placeholder="Adresse Mail">
                </div>

                <div class="col-md-6">
                    <label>Date de naissance* :</label>
                    <input name="date_naissance" class="form-control input-lg" type="date" placeholder="Date de naissance">
                </div>
